...
var BlockTemplate = module.exports = function BlockTemplate(
    ...
    if (coin.payFoundersReward === true) {
        if (!this.rpcData.founders || this.rpcData.founders.length <= 0) {
            ...
            if (!rpcData.masternode_payments_started)
            {
                ...
                //console.log(`SafeCash: ${this.rpcData.json.miner}`);
            }
            else
            {
                // console.log(this.rpcData.json);
                // Masternodes active
                blockReward = {
                    "miner": (this.rpcData.miner),
                    "infrastructure": (this.rpcData.infrastructure),
    ...
    if (typeof this.genTx === 'undefined') {
        ...
        console.log('this.merkleRoot: ' + merkle.getRoot(rpcData.json, this.genTxHash));
        */
    ...
    if (rpcData.finalsaplingroot) {
        this.hashReserved = util.reverseBuffer(new Buffer(rpcData.finalsaplingroot, 'hex')).toString('hex');
    } else {
    ...
    this.serializeHeader = function(nTime, nonce){
        ...
        console.log('this.rpcData.json.bits: ' + this.rpcData.json.bits);
        ...
        console.log('this.rpcData.json.version: ' + this.rpcData.json.version);
        */
    ...
    this.getJobParams = function(){
        if (!this.jobParams){
            this.jobParams = [
                ...
                "ce737ef3a00672c94a5880af34e4abb6ca3605f059b13c1bb1cafa75e86fe198",
                "4b462c3046c9ef30999c9c980b2340933ef55bf4d5cce2f565d8a65463551f7f",
                true
            ];
        }
