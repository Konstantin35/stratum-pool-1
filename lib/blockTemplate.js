...
var BlockTemplate = module.exports = function BlockTemplate(
    ...
    this.finalsaplingroot = util.reverseBuffer(new Buffer(this.rpcData.finalsaplingroot, 'hex')).toString('hex');
    this.hashstateroot = util.reverseBuffer(new Buffer(this.rpcData.hashstateroot, 'hex')).toString('hex');
    this.hashutxoroot = util.reverseBuffer(new Buffer(this.rpcData.hashutxoroot, 'hex')).toString('hex');
    ...
    this.getJobParams = function () {
        if (!this.jobParams) {
            this.jobParams = [
                ...
                this.finalsaplingroot,
                util.packUInt32LE(rpcData.vibpool).toString('hex'),
